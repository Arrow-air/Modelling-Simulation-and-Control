%% SCRIPT TO FIT POLYNOMIALS TO AERODYNAMIC DATABASES FRO WING-BODY AND CONTROL SURFACES
clear;
clc;
close all;

%% Load Data
adb = importdata('AerodynamicData/mga_v2_adb.dat');
...
dlmwrite("ConfigurationData/adb_w_hat.txt", adb_w_hat,' ', 0, 0);
dlmwrite("ConfigurationData/adb_w_hatSim.txt", adb_w_hat,',', 0, 0);
