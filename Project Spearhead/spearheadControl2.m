...
%%  Control
    ...
    U(:,k) =  min(1000,max(-1000,[0;0;0;0;ulv(1) + ulv(2) + ulv(3); uar(1)/2 + uar(2)/2 + uap(1)/2 + uap(2)/2 + ulp(3)/2; -uar(1)/2 + uar(2)/2 - uap(1)/2 + uap(2)/2 + ulp(3)/2; uar(3) + uap(3) + ulv(2)])); %} Constraint Saturation
